    ...
    <div class="fixed mt-28 mx-4 md:mx-auto md:w-2/3 h-3/5 rounded-2xl shadow-xl bg-white md:bg-opacity-50 inset-x-0 ">
        <div class="flex h-full">
            ...
            <div class="w-full md:w-1/2 flex px-4 flex-col justify-center">
                <form action="">
                    <p class="text-3xl text-center font-black mb-4">Вход</p>
                    ...
                    <div class="pt-4">
                        <button class="w-full h-10 px-2 text-white transition-colors duration-150 bg-blue-600 rounded-lg focus:shadow-outline hover:bg-blue-900">Пустите меня</button>
                    </div>
